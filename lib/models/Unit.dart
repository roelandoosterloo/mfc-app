...
class Unit extends Model {
  ...
  const Unit._internal({required this.id, required name, sign, createdAt, updatedAt}): _name = name, _sign = sign, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Unit({String? id, required String name, String? sign}) {
  ...
  Unit copyWith({String? id, String? name, String? sign}) {
    return Unit._internal(
      id: id ?? this.id,
      name: name ?? this.name,
      sign: sign ?? this.sign);
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'sign': _sign, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
